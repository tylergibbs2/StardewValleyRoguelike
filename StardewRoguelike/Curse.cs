...
namespace StardewRoguelike
{
    ...
    internal class Curse : Buff
    {
        ...
        private static readonly Dictionary<CurseType, (string, string)> CurseData = new()
        {
            ...
            { CurseType.DamageOverTime, ("Damage Over Time", "You take damage over time but you take 1.5x more.") },
            ...
            { CurseType.HealOverTime, ("Heal Over Time", "You heal over time but heal 1.5x more.") },
